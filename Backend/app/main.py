...
# ── V2 MODULES ────────────────────────────────────────────────────────────────────────────────
from app.routes import prescriptions, followups, timeline, queue, lab_orders, referrals, invoices, payments
...
origins = [
    ...
    "https://sehat-sathi-ce58.onrender.com",
]
...
app.include_router(payments.router)        # Razorpay Payment Gateway Engine
